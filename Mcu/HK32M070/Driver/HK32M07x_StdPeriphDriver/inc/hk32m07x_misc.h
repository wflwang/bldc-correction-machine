/********************************************************************************
  ...
  * @filename: hk32m07x_misc.h 
  * @brief: MISC Initialization and Configuration functions
  * @Author: AE Team 
  * @version: V1.0.0/2024-12-11
*********************************************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __hk32m07x_MISC_H
#define __hk32m07x_MISC_H
...
typedef struct
{
  uint8_t NVIC_IRQChannel;             /*!< Specifies the IRQ channel to be enabled or disabled.
                                            ...
                                            please refer to hk32m07x.h file) */
