...
* @filename:  hk32m07x_i2c.c
* @brief:     I2C Initialization and Configuration functions.
* @author:    AE Team
...
/** @defgroup I2C_Group3 I2C registers management functions
...
/** @defgroup I2C_Group4 Data transfers management functions
...
/** @defgroup I2C_Group5 Interrupts and flags management functions
...
/**
  ...
  * @param  I2Cx: where x can be from 1  to select the I2C peripheral.
