...
typedef struct
{
  ...
  uint16_t AvIBus_d;    /*!< It contains latest available average Ibus
                               expressed in digit */
  uint16_t BusVoltage_mV;    /*!< It contains latest available average Vbus
                               expressed in mV */    
  uint16_t IBusVoltage_mA;    /*!< It contains latest available average Ibus
                               expressed in mA */ 
  uint16_t Power_mW;    /*!< It contains latest available average Power
                               expressed in digit */                                
