/**
  ...
  * @file    sto_cordic_speed_pos_fdbk.c
	...
	* @date    2021-08-07
 ===========================================================================
                    ##### How to use cordic speed position  #####
 ===========================================================================
		 [..]
     (#) This file provides firmware functions that implement the following features
         of the cordic speed & position Control component of the Motor Control SDK.
    @endverbatim
  ****************************************************************************** 
  */
...
/** @defgroup initialization and reset module  
  * @brief speed & position cordic related variables initialization
 
@verbatim
 ===============================================================================
      ##### Initialize and reset cordic related component #####
 ===============================================================================
@endverbatim
  * @{
  */
...
/** @defgroup Get speed information 
  * @brief Angle & speed information calculation related module 
 
@verbatim
 ===============================================================================
      ##### Calculated angle and get speed related information #####
 ===============================================================================
@endverbatim
  * @{
  */
...
/**
  ...
  * @retval int16_t rotor electrical angle (s16degrees)
  */
inline static int16_t STO_CR_ExecuteCORDIC( STO_CR_Handle_t * pHandle, int32_t wBemf_alfa_est, int32_t                                    wBemf_beta_est )
{
  int16_t hAngle;
...
/** @defgroup  Information Export module 
  * @brief Export cordic speed related information
 
@verbatim
 ===============================================================================
                 #####  Export Bemf related information functions  #####
 ===============================================================================
@endverbatim
  * @{
  */
...
/** @defgroup  State Information check module 
  * @brief Check related state
 
@verbatim
 ===============================================================================
            #####   Check cordic speed information state functions  #####
 ===============================================================================
@endverbatim
  * @{
  */
