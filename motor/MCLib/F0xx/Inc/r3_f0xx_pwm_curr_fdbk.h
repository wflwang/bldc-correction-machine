...
typedef struct
{
  ...
  ATU_TypeDef * ATUx;                  /*!< It contains the pointer to the timer
...
/**
  * @brief  Handle structure of the r3_f0xx_pwm_curr_fdbk Component
  */
typedef struct
{
...
/**
  ...
  * reading configuration using HK32ASPIN010.
  */
