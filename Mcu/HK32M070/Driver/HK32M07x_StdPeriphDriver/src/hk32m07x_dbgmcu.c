...
/** @defgroup DBGMCU_Private_Defines DBGMCU Private Defines
  * @{
  */
...
/** @defgroup DBGMCU_Private_Functions DBGMCU Private Functions
  * @{
  */
...
/**
  * @brief  Configures APB peripheral behavior when the MCU is in Debug mode.
  * @param  DBGMCU_Periph: specifies the APB peripheral.
  *         This parameter can be any combination of the following values:
  *            @arg DBGMCU_WWDG_STOP: Debug WWDG stopped when Core is halted
  *            @arg DBGMCU_IWDG_STOP: Debug IWDG stopped when Core is halted
  * @param  NewState: new state of the specified APB peripheral in Debug mode.
  *         This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
{
    /* Check the parameters */
    assert_param(IS_DBGMCU_APBPERIPH(DBGMCU_Periph));
    assert_param(IS_FUNCTIONAL_STATE(NewState));
